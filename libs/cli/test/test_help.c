...
spec(help) {
    ...
    it("can write a help page for an empty app") {
        ...
        anvil_eq_string(dynstring_view(&string), string_lit("usage: atlas_cli_test\n"));
    ...
    it("can write a help page for an app with a description") {
        ...
        anvil_eq_string(
            ...
            string_lit("usage: atlas_cli_test\n"
                       "\n"
                       "Hello world\n"
                       "My test app\n"));
    ...
    it("can write a help page for an app with arguments") {
        ...
        anvil_eq_string(
            dynstring_view(&string),
            string_lit("usage: atlas_cli_test <src-path> [<dst-path>]\n"
                       "\n"
                       "Arguments:\n"
    ...
    it("can write a help page for an app with flags") {
        ...
        anvil_eq_string(
            dynstring_view(&string),
            string_lit("usage: atlas_cli_test [-v] [-c <value>]\n"
                       "\n"
                       "Flags:\n"
    ...
    it("can write a help page for an app with an descriptions, arguments and flags") {
        ...
        anvil_eq_string(
            dynstring_view(&string),
            string_lit("usage: atlas_cli_test [-v] [-c <value>] <src-path> [<dst-path>]\n"
                       "\n"
                       "My app\n"
                       "\n"
                       "Arguments:\n"
