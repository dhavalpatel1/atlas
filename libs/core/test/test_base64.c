...
spec(base64) {
    ...
    it("can decode helloworld") {
        ...
        anvil_eq_string(decoded, string_lit("Hello World"));
    }
    ...
    it("can decode content with 2 padding characters") {
        ...
        anvil_eq_string(decoded, string_lit("any carnal pleasure"));
    }
