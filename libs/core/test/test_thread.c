...
spec(thread) {
    ...
    it("can store and load integers atomically") {
        ...
        thread_join(exec);
        anvil_eq_int(thread_atomic_load_i64(&value), 1337);
    }
    ...
    it("can add integers atomically") {
        ...
        thread_join(exec);
        anvil_eq_int(thread_atomic_load_i64(&value), 20000);
    }
    ...
    it("can substract integers atomically") {
        ...
        thread_join(exec);
        anvil_eq_int(thread_atomic_load_i64(&value), 0);
    }
