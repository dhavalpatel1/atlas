...
spec(write) {
    ...
    it("can write arrays") {
        ...
        anvil_eq_string(dynstring_view(&buffer), string_lit("[null,true,\"Hello\"]"));
    }
    ...
    it("can write objects") {
        ...
        json_write(&buffer, doc, val, &json_write_opts(.flags = JsonWriteFlags_None));
        anvil_eq_string(dynstring_view(&buffer), string_lit("{\"a\":null,\"b\":true,\"c\":\"Hello\"}"));
    }
    ...
    it("can write strings with escape sequences") {
        ...
        json_write(&buffer, doc, val, &json_write_opts(.flags = JsonWriteFlags_None));
        anvil_eq_string(dynstring_view(&buffer), string_lit("\"\\bHello\\tWorld\\n\""));
    }
    ...
    it("can write numbers") {
        ...
        json_write(&buffer, doc, val, &json_write_opts(.flags = JsonWriteFlags_None));
        anvil_eq_string(dynstring_view(&buffer), string_lit("42.1337"));
    }
    ...
    it("can write true") {
        ...
        anvil_eq_string(dynstring_view(&buffer), string_lit("true"));
    }
    ...
    it("can write false") {
        ...
        json_write(&buffer, doc, trueVal, &json_write_opts(.flags = JsonWriteFlags_None));
        anvil_eq_string(dynstring_view(&buffer), string_lit("false"));
    }
    ...
    it("can write null") {
        ...
        json_write(&buffer, doc, val, &json_write_opts(.flags = JsonWriteFlags_None));
        anvil_eq_string(dynstring_view(&buffer), string_lit("null"));
    }
